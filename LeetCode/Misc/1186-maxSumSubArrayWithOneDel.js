 ...
 *delete one element from it so that there is still at least one element left and the sum of
 ...
 *You can't choose [-1] and delete -1 from it, then get an empty subarray to make the sum
 *equals to 0.
 *
 *Constraints:
 *1 <= arr.length <= 105
